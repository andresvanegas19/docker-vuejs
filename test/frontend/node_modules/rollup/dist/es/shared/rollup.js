...
class Chunk$1 {
    ...
    setIdentifierRenderResolutions({ format, interop }) {
        ...
        deconflictChunk(this.orderedModules, this.getDependenciesToBeDeconflicted(format !== 'system', format !== 'es' && format !== 'system', interop, format === 'amd'), this.imports, usedNames, format, interop, this.outputOptions.preserveModules, this.outputOptions.externalLiveBindings, this.chunkByModule, syntheticExports, this.exportNamesByVariable, this.accessedGlobalsByScope);
    }
